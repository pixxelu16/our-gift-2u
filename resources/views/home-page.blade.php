                    ...
                    <div class="slide__content">
                        <div class="slide__content--headings">
                            ...
                            <p class="animated" data-animation-in="fadeInRight" data-delay-in="0.2">For every dollar
                                redeemed from your gift card, we will<br> donate an equal amount in gift to our different<br>
                                selected charities to deliver to kids in need.
                            </P>
                            <img src="{{ url('public/images/banner-logo.png') }}" class="banner-new-logo animated"  data-animation-in="fadeInRight">
                            @if (!Auth::check())
                    ...
                    <div class="slide__content">
                        <div class="slide__content--headings">
                            ...
                            <p class="animated color-black" data-animation-in="fadeInUp" data-delay-in="0.3">
                              Absolutely! We love Christmas, and we're thrilledto give <br> presents to all our members! 🎄 Don’t miss out on the fun—<br> register now and join in the celebration!
                            </p>
                            @if (!Auth::check())
                ...
                <div class="container">
                    <div class="slide__content">
                        <div class="slide__content--headings">
                            ...
                            <p class="animated" data-animation-in="fadeInRight" data-delay-in="0.2">With any gift card purchase for Valentine’s <br>  Day, you’ll receive a second gift card of <br> the same value for free.
                              Get your code today! 
                            </p>
                            @if (!Auth::check())
                                <a href="{{ url('redeem-center') }}" class="green-button"
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-6">
            <div class="get-upto-left">
               ...
               <p>Earn more every time you shop! Use your debit card to unlock up to 12% back in reward points on every purchase. Whether you're shopping for daily essentials or indulging in your favorite brands, you’ll rack up points with every swipe. Redeem these points for exclusive offers, discounts, and more. It’s simple, rewarding, and adds value to every purchase!</p>
               @if (!Auth::check())
                <a href="{{ url('redeem-center') }}">Join In <img src="{{ url('public/images/orange-erow.svg') }}"></a>
               @endif
            </div>
         </div>
         <div class="col-md-6">
            <div class="get-upto-right">
               ...
               <div class="get-up-product">
                  ...
                  @foreach ($banner_two_products as $banner_two)
                     <li><a href="{{ url('product/' . $banner_two['product_slug']) }}"><img src="{{ url('public/uploads/products/' . $banner_two['image']) }}" class="banner-two-img"><span>{{ number_format($banner_two['product_price'], 2, '.', ',') }}</span></a></li>
                  @endforeach
                  </ul>
               </div>
               @endif
    ...
    <div class="container">
        <div class="help-childern-saction">
            ...
            <div class="logo-52-orange"><a href="{{ url('/') }}"><img src="{{ url('public/images/52-logo-small.png') }}"></a></div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="my-rewards-righ">
                        <div class="about-logo-new"><img src="{{ url('public/images/banner-logo.png') }}" class="small-logo"></div>
                        <span>my gift card</span>
                        <h2>Redeem you gift card today</h2>
                        <p>Recieving your gift to your door steps!</p>
                        @if (!Auth::check())
                            <a href="{{ url('redeem-center') }}">Redeem center<img src="{{ url('public/images/join-erow.svg') }}"></a>
                        @endif
