        ...
        <div class="accordion__wrapper">
            ...
            <div class="accordion">
                <div class="accordion__header">
                    <h2 class="accordion__question">DEBIT CARD PROMOTION </h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="acccording-box-right">
                                    ...
                                    <div class="button-register"><button>Register</button></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="accordion">
                <div class="accordion__header">
                    <h2 class="accordion__question"> WORD OF MOUTH REWARD  </h2>
                    <span class="accordion__icon"><i id="accordion-icon" class="ri-add-line"></i></span>
                </div>
                <div class="accordion__content">
                    <div class="acccording-box-body">
            ...
            <div class="accordion">
                <div class="accordion__header">
                    <h2 class="accordion__question">AUSSIE RULES PROMOTION </h2>
                    <span class="accordion__icon"><i id="accordion-icon" class="ri-add-line"></i></span>
                </div>
                <div class="accordion__content">
                    <div class="acccording-box-body">
            ...
            <div class="accordion">
                <div class="accordion__header">
                    <h2 class="accordion__question"> SOCCER PERKS PROMOTION  </h2>
                    <span class="accordion__icon"><i id="accordion-icon" class="ri-add-line"></i></span>
                </div>
                <div class="accordion__content">
                    <div class="acccording-box-body">
            ...
            <div class="accordion">
                <div class="accordion__header">
                    <h2 class="accordion__question"> IN2SPORTS PROMOTION </h2>
                    <span class="accordion__icon"><i id="accordion-icon" class="ri-add-line"></i></span>
                </div>
                <div class="accordion__content">
                    <div class="acccording-box-body">
            ...
            <div class="accordion">
                <div class="accordion__header">
                    <h2 class="accordion__question">  GOURMET PROMOTION   </h2>
                    <span class="accordion__icon"><i id="accordion-icon" class="ri-add-line"></i></span>
                </div>
                <div class="accordion__content">
                    <div class="acccording-box-body">
